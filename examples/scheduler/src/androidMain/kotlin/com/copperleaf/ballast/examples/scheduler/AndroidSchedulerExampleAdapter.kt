...
public class AndroidSchedulerExampleAdapter :
    ...
    Function1<SchedulerExampleContract.Inputs, Unit> {
    companion object {
    ...
    override fun invoke(p1: SchedulerExampleContract.Inputs) {
        check(p1 is SchedulerExampleContract.Inputs.Increment)

        Notifications.notify(
            context = MainApp.INSTANCE!!,
            title = "Ballast Scheduler",
            message = p1.scheduleKey
        )
    }
}
